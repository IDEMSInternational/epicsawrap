...
definitions <- function(country, definitions_id, summaries, file = NULL){
  definition_data <- epicsadata::get_definitions_data(country = country, station_id = definitions_id, file = file)
